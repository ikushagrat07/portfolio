...
<head>
    ...
    <!-- font icons -->
    <link rel="stylesheet" href="<?php echo asset('public/vendors/themify-icons/css/themify-icons.css') ?>">

    <!-- Bootstrap + JohnDoe main styles -->
	<link rel="stylesheet" href="<?php echo asset('public/css/johndoe.css') ?>">
</head>
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">

   <!-- <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script> -->
     <!-- Toastr JavaScript CDN -->
     <script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js" integrity="sha512-Zad0+lLDOZ3D5i/4dHVhBQOzKBICmwea4RD8r0B4vtUZz5ep9tiJ4W7/0vC/EplXvsOqF4x+e9W/y07TBlXD4A==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <header class="header">
        <div class="container">
            <!-- <ul class="social-icons pt-3">
                ...
                <h3 class="header-title">Kushagra Pandey</h3>
                <h6 class="header-mono">Back End Developer</h6>
                <button class="btn btn-primary btn-rounded" onclick="window.location.href='/cart-management/get-pdf'">Print Resume</button>
            </div>
            ...
            <div class="container">
                ...
                <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav brand">
                        <img src="<?php echo asset('public/imgs/profile.jpeg" alt="" class="brand-img') ?>">
                        <li class="brand-txt">
                            <h4 class="brand-title">Kushagra Pandey</h4>
                            <div class="brand-subtitle"> <h6>Web Developer</h6></div>
                </li>
                </ul>
        ...
        <div id="about" class="row about-section">
            ...
            <div class="col-lg-4 about-card">
                ...
                <ul class="mt40 info list-unstyled">
                    <li><span>Birthdate</span> : 15/08/2004</li>
                    <li><span>Email</span> : iamkushagra15@gmail.com</li>
                    <li><span>Phone</span> : +917453859107</li>
                    <li><span>Skype</span> : Kushagra</li>
                    <li><span>Address</span> : 75 Y block,Sector 12,Noida(Uttar Pradesh)</li>
                </ul>
                <ul class="social-icons pt-3">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                       <div class="card-header">
                        ...
                        <div class="card-body">
                        <!-- <div class="item">
                            <h3 class="title"><i class="fa fa-graduation-cap"></i> Bachelor of Commerce (Honours)</h3>
                            <h4 class="university"><a href="https://rajshree.ac.in/">Rajshree Institute Of Management And Technology, Bareilly </a><span class="year">(2014-2016)</span></h4>
                            </div> -->
                            <h2 class="title text-primary">2021 - Present</h2>
                            <P><h5>Bachelor of Commerce (Honours)<h5></P>
                            <P class="subtitle"><h5 class="subtitle text-dark"><a  href="https://rajshree.ac.in/">RIMT, Bareilly</h5> </a></P>
                            <hr>
                            <h1 class="title text-danger">2020 - 2021</h1>
                            <P><h5>Intermediate</h5></P>
                            <P class="subtitle text-danger "><h5><a  href="http://www.gyansthalilbvm.ac.in/">L.B.V.M Sr. Sec. School, Pilibhit</h5> </a></P>
                            <hr>
                            <h4 class="title text-danger">2018 - 2019</h4>
                            <P><h5>High School Degree</h5></P>
                            <P class="subtitle text-danger "><h5><a  href="http://www.gyansthalilbvm.ac.in/">L.B.V.M Sr. Sec. School, Pilibhit</h5> </a></P>
                        </div>
                    </div>
                </div>
                       ...
                       <div class="card-header">
                        ...
                        <div class="card-body pb-2">
                           <h6> HTML &amp; CSS3</h6>
                            ...
                            <h6>PHP</h6>
                            <div class="progress mb-3">
                                <div class="progress-bar bg-da
                                nger" role="progressbar" style="width: 80%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <h6>MYSQL</h6>
                            <div class="progress mb-3">
                ...
                <div class="portfolio-container">
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="<?php echo asset('public/imgs/web-1.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates') ?>">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo asset('public/imgs/web-1.jpg') ?>"></a>
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="<?php echo asset('public/imgs/web-2.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates') ?>">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo asset('public/imgs/web-2.jpg') ?>"></a>
                                <div class="text-holder">
                                    <h6 class="title">WEB</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="<?php echo asset('public/imgs/advertising-2.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates') ?>">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo asset('public/imgs/advertising-2.jpg') ?>"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 web">
                        <div class="portfolio-item">
                            <img src="<?php echo asset('public/imgs/web-4.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates') ?>">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo asset('public/imgs/web-4.jpg') ?>"></a>
                                <div class="text-holder">
                                    <h6 class="title">WEB</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 advertising">
                        <div class="portfolio-item">
                            <img src="<?php echo asset('public/imgs/advertising-1.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates') ?>">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo asset('public/imgs/advertising-1.jpg') ?>"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="<?php echo asset('public/imgs/web-3.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates') ?>">
                           <div class="content-holder">
                                <a class="img-popup" href="<?php echo asset('public/imgs/web-3.jpg') ?>"></a>
                                <div class="text-holder">
                                    <h6 class="title">WEB</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="<?php echo asset('public/imgs/advertising-3.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates') ?>">
                           <div class="content-holder">
                                <a class="img-popup" href="<?php echo asset('public/imgs/advertising-3.jpg') ?>"></a>
                                <div class="text-holder">
                                    <h6 class="title">ADVERSITING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="<?php echo asset('public/imgs/advertising-4.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates') ?>">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo asset('public/imgs/advertising-4.jpg') ?>"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding new">
                        <div class="portfolio-item">
                            <img src="<?php echo asset('public/imgs/branding-1.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates') ?>">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo asset('public/imgs/branding-1.jpg') ?>"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="<?php echo asset('public/imgs/branding-2.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates') ?>">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo asset('public/imgs/branding-2.jpg') ?>"></a>
                                <div class="text-holder">
                                    <h6 class="title">BRANDING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 branding new">
                        <div class="portfolio-item">
                            <img src="<?php echo asset('public/imgs/branding-3.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates') ?>">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo asset('public/imgs/branding-3.jpg') ?>"></a>
                                <div class="text-holder">
                                    <h6 class="title">BRANDING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="<?php echo asset('public/imgs/branding-4.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates') ?>">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo asset('public/imgs/branding-4.jpg') ?>"></a>
                                <div class="text-holder">
                                    <h6 class="title">BRANDING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="<?php echo asset('public/imgs/branding-5.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates') ?>">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo asset('public/imgs/branding-5.jpg') ?>"></a>
                                <div class="text-holder">
                                    <h6 class="title">BRANDING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
            ...
            <div class="row">
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="<?php echo asset('public/imgs/blog1.jpg" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page') ?>">
                    </div>
                    <div class="content-holder">
                ...
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="<?php echo asset('public/imgs/blog2.jpg" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page') ?>">
                    </div>
                    <div class="content-holder">
                ...
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="<?php echo asset('public/imgs/blog3.jpg" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page') ?>">
                    </div>
                    <div class="content-holder">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="contact-form-card">
                        ...
                        <!-- <form action="<?php //echo route('addData');?>" method="post" > -->
                        <form action="<?php //echo route('addData');?> " id="submitBtn" >
                            ...
                            <div class="form-group ">
                                <button type="submit" id="submitBtn" class="form-control btn btn-primary" >Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-10 ">
                                <h6 class="d-inline">Phone : <br> <span class="text-muted">+917453859107</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Address :<br> <span class="text-muted">75 Y block,Sector 12,Noida(Uttar Pradesh)</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Email :<br> <span class="text-muted">iamkushagra15@gmail.com</span></h6>
                            </div>
                        </div>
    ...
    <footer class="footer py-3">
        <div class="container">
            <p class="small mb-0 text-light">
                &copy; <script>document.write(new Date().getFullYear())</script> Created With <i class="ti-heart text-danger"></i> By <a href="https://www.instagram.com/__its.kushhh__/?igsh=am84aWkzbTdrNzV5" target="_blank"><span class="text-danger" title="Bootstrap 4 Themes and Dashboards">Kushagra Pandey</span></a>
            </p>
        </div>
    </footer>

	<!-- core  -->
    <script src="<?php echo asset('public/vendors/jquery/jquery-3.4.1.js') ?>"></script>
    <script src="<?php echo asset('public/vendors/bootstrap/bootstrap.bundle.js') ?>"></script>

    <!-- bootstrap 3 affix -->
    <script src="<?php echo asset('public/vendors/bootstrap/bootstrap.affix.js') ?>"></script>

    <!-- Isotope  -->
    <script src="<?php echo asset('public/vendors/isotope/isotope.pkgd.js') ?>"></script>

    <!-- Google mpas -->
    <script async defer src="<?php //echo asset('/public/https://maps.googleapis.com/maps/api/js?key=AIzaSyCtme10pzgKSPeJVJrG1O3tjR6lk98o4w8&callback=initMap') ?>"></script>

    <!-- JohnDoe js -->
    <script src="<?php echo asset('public/js/johndoe.js') ?>"></script>
    <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
</body>
</html>
